...
@Component({
    selector: 'app-agent-driver-detail',
    templateUrl: './agent-driver-detail.component.html',
    styleUrls: ['./agent-driver-detail.component.scss'],
    host: { "id": "main" }
})
export class AgentDriverDetailComponent {
    ...
    async ngOnInit() {
        this.file_url = 'http://localhost:7790/file/'
